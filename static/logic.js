...
//       '<i style="background:' + chooseColor(grades[i]) + ' "></i> ' + grades[i] + (breaks ? ' ' + '<br>' : '');
//  }
//  return div;
// };
  ...
  // }
        ...
        // '<i style="background:' + chooseColor(grades[i]) + '"></i> ' + grades[i];
        // + (grades[i+1]);
          // ? '&ndash;');
        // + grades[i]);
        // + '<br>' : '+');
...
// Import Data
d3.csv("/data/filtered_fire.csv").then(function(firedata) {
